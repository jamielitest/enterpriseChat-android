package com.easemob.chatuidemo.manager;
...
import com.easemob.chatuidemo.db.Contract;
...
public class QiXinManager {
	...
	public void saveQXUser(QXUser user){
        ...
        if(db.isOpen()){
            ...
            values.put(Contract.ContractUserTable.COLUMN_NAME_AVATORPATH, user.getAvatorPath());
