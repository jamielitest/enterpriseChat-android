...
public class QXUser extends ParseUser{
	...
	public static final String PROP_AVATORPATH = "avatorpath";
...
//		return getString(PROP_HXID);
	...
	public String getAvatorPath() {
		return getString(PROP_AVATORPATH);
	}

	public void setAvatorPath(String avatorPath) {
		if(avatorPath != null)
			put(PROP_AVATORPATH, avatorPath);
	}

	public String getAvatorUrl() {
		return getString(PROP_AVATAR);
	}

	public void setAvatorUrl(String avatarUrl) {
		if(avatarUrl != null)
			put(PROP_AVATAR, avatarUrl);
	}
	...
	public void setPropertiesJson(JSONObject json) {
	    ...
	    public Map<String,Object> getAllProperties(){
	        ...
	        allAttr.put(PROP_AVATAR, getAvatorUrl());
