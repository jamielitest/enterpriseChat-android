...
public class DemoApplication extends Application {
	...
	public void onCreate() {
        ...
        ParseManager.getInstance().onInit(this);
	}
	...
	public void setQXUsers(List<QXUser> qxUsers){
		this.allUsers = qxUsers;
	}
	
	public synchronized QiXinManager getQXManager(){
		if(qxManager == null){
			qxManager = new QiXinManager(instance);
		}
		return qxManager;
	}
